...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	Лог.Информация("Начало выполнение команды <unlock>");
	...
	МенеджерКоманд.ВыполнитьРазблокировкуПользователей();

	Лог.Информация("Завершено выполнение команды <unlock>");

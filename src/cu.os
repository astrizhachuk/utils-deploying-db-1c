...
Процедура ВыполнитьПриложение()
	...
	Приложение.ДобавитьКоманду("kill k", "принудительное уничтожение сеанса (соединений) с кластером серверов",
					Новый КомандаKill);

	Приложение.ДобавитьКоманду("lock l", "блокировка сеансов",
					Новый КомандаLock);

	Приложение.ДобавитьКоманду("unlock u", "снятие блокировки сеансов",
					Новый КомандаUnlock);
